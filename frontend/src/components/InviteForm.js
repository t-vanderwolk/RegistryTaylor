...
const InviteForm = () => {
  ...
  return (
    <section
      id="request-invite"
      tabIndex="-1"
      className="relative mx-auto mt-24 max-w-5xl overflow-hidden rounded-[3.5rem] border border-babyPink/40 bg-gradient-to-br from-white/92 via-babyPink/12 to-softBeige/70 px-6 py-16 shadow-soft backdrop-blur-sm sm:px-10 md:px-16"
    >
      ...
      <div className="relative grid gap-12 md:grid-cols-[1fr,1.2fr] md:items-center">
        <header className="space-y-4 text-center md:text-left">
          ...
          <h2 className="text-4xl font-heading text-blueberry">Request Your Invite</h2>
          <span className="gold-divider md:ml-0" aria-hidden="true" />
          <p className="mx-auto max-w-md text-base leading-relaxed text-midnight/75 md:mx-0">
        ...
        <form onSubmit={handleSubmit} className="space-y-6" noValidate>
          <div className="grid gap-5 sm:grid-cols-2">
            <label className="flex flex-col gap-2 text-left text-sm font-heading uppercase tracking-[0.35em] text-babyPink/70">
              Name
              <input
                type="text"
                name="name"
                ...
                className="rounded-2xl border border-babyBlue/35 bg-white/90 px-4 py-3 font-body text-sm text-midnight shadow-inner focus:border-babyBlue focus:outline-none focus:ring-2 focus:ring-babyBlue/60"
              />
            </label>
            <label className="flex flex-col gap-2 text-left text-sm font-heading uppercase tracking-[0.35em] text-babyPink/70">
              Email
          ...
          <div className="flex flex-col items-center justify-between gap-3 rounded-3xl border border-babyPink/35 bg-white/85 px-5 py-4 text-xs font-body uppercase tracking-[0.35em] text-midnight/70 sm:flex-row">
            ...
            <button
              type="submit"
              className={`inline-flex items-center justify-center rounded-full bg-blueberry px-10 py-3 text-xs font-heading uppercase tracking-[0.4em] text-cream shadow-soft transition hover:-translate-y-1 hover:scale-[1.02] hover:bg-midnight focus:outline-none focus-visible:ring-2 focus-visible:ring-babyBlue/60 focus-visible:ring-offset-2 focus-visible:ring-offset-white ${
