...
=======
    <article className="flex h-full flex-col rounded-[2rem] border border-primary/20 bg-white/95 p-6 shadow-soft transition duration-300 hover:-translate-y-1 hover:shadow-dreamy">
>>>>>>> heroku/main
...
=======
        <h3 className="font-serif text-xl text-blueberry sm:text-2xl">{seat.name}</h3>
        {seat.subtype && <p className="mt-1 text-xs font-heading uppercase tracking-[0.28em] text-primary/70">{seat.subtype}</p>}
        {seat.travelSystemCompatible && (
          <span className="mt-2 inline-block rounded-full bg-primary px-3 py-1 text-[0.65rem] font-heading uppercase tracking-[0.28em] text-white">
>>>>>>> heroku/main
            Travel System
          </span>
        )}
...
=======
          <strong className="font-semibold text-blueberry">Weight:</strong> {seat.weightRange}
        </p>
        <p className="text-sm leading-relaxed text-neutral-600">
          <strong className="font-semibold text-blueberry">Install:</strong> {seat.installation}
>>>>>>> heroku/main
        </p>
...
=======
          className="mt-auto inline-flex items-center justify-center gap-2 rounded-full bg-primary px-5 py-2 text-xs font-heading uppercase tracking-[0.3em] text-white transition hover:-translate-y-1 hover:scale-105 hover:shadow-md"
>>>>>>> heroku/main
        >
          Learn More
        </Link>
...
=======
        <p className="text-xs font-heading uppercase tracking-[0.35em] text-primary/80">Comparison Guide</p>
        <h2 className="text-3xl font-serif text-blueberry sm:text-4xl">Car Seat Comparison Guide</h2>
>>>>>>> heroku/main
...
=======
        <h3 className="font-serif text-2xl text-blueberry sm:text-3xl">Infant Car Seats</h3>
>>>>>>> heroku/main
        <p className="max-w-3xl text-sm leading-relaxed text-neutral-600 sm:text-base">
...
=======
        <h3 className="font-serif text-2xl text-blueberry sm:text-3xl">Convertible Car Seats</h3>
>>>>>>> heroku/main
        <p className="max-w-3xl text-sm leading-relaxed text-neutral-600 sm:text-base">
...
=======
        <h3 className="font-serif text-2xl text-blueberry sm:text-3xl">Booster Seats</h3>
>>>>>>> heroku/main
        <p className="max-w-3xl text-sm leading-relaxed text-neutral-600 sm:text-base">
...
=======
      <div className="rounded-[2.5rem] border border-primary/20 bg-softPink/40 px-8 py-10 text-center shadow-soft sm:text-left">
        <p className="text-lg font-serif text-blueberry sm:text-xl">Still unsure about the right fit?</p>
>>>>>>> heroku/main
...
=======
            className="inline-flex items-center justify-center gap-2 rounded-full bg-primary px-6 py-3 text-xs font-heading uppercase tracking-[0.3em] text-white transition hover:-translate-y-1 hover:scale-105 hover:shadow-md"
>>>>>>> heroku/main
          >
            Book a Consultation
          </Link>
...
=======
            className="inline-flex items-center justify-center gap-2 rounded-full border border-primary/30 px-6 py-3 text-xs font-heading uppercase tracking-[0.3em] text-primary transition hover:-translate-y-1 hover:scale-105 hover:bg-white"
>>>>>>> heroku/main
          >
            Request Invite
          </Link>
