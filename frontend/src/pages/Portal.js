...
const Portal = () => {
  ...
  return (
    <main className="min-h-screen bg-cream text-blueberry px-6 py-20">
      <div className="mx-auto max-w-2xl rounded-[2.5rem] border border-babyPink/40 bg-white/90 p-10 text-center shadow-soft backdrop-blur-sm">
        <h1 className="font-playful text-3xl mb-4">Member Portal</h1>
        ...
        <p className="mt-4 text-sm text-pebble/60">
        ...
        >
          ...
          <label className="block text-sm text-pebble/80">
            Email
            <input
              type="email"
              value={login.email}
          ...
          <button
            type="submit"
            className="w-full rounded-full bg-babyPink px-6 py-3 text-xs font-semibold uppercase tracking-[0.3em] text-blueberry shadow-pop transition-transform duration-200 hover:-translate-y-1 hover:shadow-dreamy"
          >
            Sign In
          </button>
        </form>
