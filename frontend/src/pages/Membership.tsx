  ...
  return (
    <PageWrapper>
      ...
      >
        <PageHeader
          eyebrow="Memberships"
          title="Choose the cadence that fits your family"
          description="Membership opens the door to calm decision-making, heartfelt celebrations, and gentle accountability. Every tier includes Taylor’s personal oversight and NDA-backed discretion."
        >
