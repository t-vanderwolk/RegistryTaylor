...
import type { AnnouncementCardData } from "@/app/dashboard/member/types";
      ...
      <div className="flex snap-x snap-mandatory gap-4 overflow-x-auto pb-2 md:flex-col md:gap-4 md:snap-none md:overflow-visible">
        {announcements.map((item, index) => (
          ...
          >
            ...
            <Link
              href={item.href}
              className="mt-3 inline-flex items-center gap-1 text-xs font-semibold uppercase tracking-[0.3em] text-mauve-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-mauve-300/60 focus-visible:ring-offset-2 focus-visible:ring-offset-ivory"
            >
