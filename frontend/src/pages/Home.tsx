      ...
      >
        ...
        >
          <PageHeader
            ...
            description="Taylor-Made Baby Co. curates registries, nursery experiences, and celebrations with a warm, concierge touch. We believe calm timelines, heartfelt details, and artful styling help families savor every milestone."
            align="left"
            eyebrowClassName="bg-primary/40 text-ink"
            className="gap-6 text-left"
          />
