    ...
    <div className="space-y-16 pb-24 pt-16">
      <section className="relative mx-auto max-w-5xl overflow-hidden rounded-[3.5rem] border border-primary/25 bg-white text-left shadow-soft">
        ...
        <div className="relative flex flex-col gap-6 px-6 py-12 sm:px-12 sm:py-16">
          ...
          <div className="text-xs font-serif uppercase tracking-[0.32em] text-primary/80">Taylor-Made Guide</div>
          <h1 className="text-3xl font-serif text-blueberry sm:text-4xl md:text-5xl">Car Seats, Simplified</h1>
          ...
          <div className="grid gap-4 pt-4 text-sm leading-relaxed text-neutral-600 sm:grid-cols-2">
            <div className="rounded-3xl border border-primary/20 bg-white/85 p-6 shadow-soft backdrop-blur-sm">
              <p className="font-heading text-xs uppercase tracking-[0.3em] text-primary/70">What to expect</p>
              <p className="mt-3">
            ...
            <div className="rounded-3xl border border-primary/20 bg-white/85 p-6 shadow-soft backdrop-blur-sm">
              <p className="font-heading text-xs uppercase tracking-[0.3em] text-primary/70">Need a bespoke list?</p>
              <p className="mt-3">
      ...
      <section className="mx-auto max-w-5xl space-y-6 rounded-[3rem] border border-primary/25 bg-white px-6 py-12 text-center shadow-soft sm:px-12 sm:text-left">
        <header className="space-y-3">
          <p className="text-xs font-serif uppercase tracking-[0.32em] text-primary/80">Concierge Support</p>
          <h2 className="text-3xl font-serif text-blueberry sm:text-4xl">Ready for one-on-one support?</h2>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 sm:justify-start">
          <Button to="/contact" className="bg-primary !text-white px-8 py-3" size="sm">
            Book Consultation
          </Button>
