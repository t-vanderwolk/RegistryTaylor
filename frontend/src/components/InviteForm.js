...
const InviteForm = () => {
  ...
  return (
    <section
      ...
      tabIndex="-1"
<<<<<<< HEAD
      className="relative mx-auto mt-24 max-w-5xl overflow-hidden rounded-[3.5rem] border border-blush/40 bg-mauve/10/50 px-6 py-16 shadow-soft backdrop-blur-sm motion-safe:animate-fade-in-up sm:px-10 md:px-16"
    >
      <div className="pointer-events-none absolute -left-24 top-16 h-64 w-64 rounded-full bg-blush/35 blur-3xl" aria-hidden="true" />
      <div className="pointer-events-none absolute -right-16 bottom-0 h-72 w-72 rounded-full bg-blush/25 blur-3xl" aria-hidden="true" />
      <div className="pointer-events-none absolute left-1/2 top-8 h-px w-40 -translate-x-1/2 bg-gradient-to-r from-transparent via-blush/45 to-transparent" aria-hidden="true" />
      ...
      <div className="relative grid gap-12 md:grid-cols-[1fr,1.2fr] md:items-center">
        <header className="space-y-4 text-center md:text-left">
          ...
          <h2 className="text-4xl font-serif font-heading text-charcoal">Request Your Invite</h2>
=======
...
<<<<<<< HEAD
          <div className="relative overflow-hidden rounded-[2.5rem] border border-blush/45">
=======
...
<<<<<<< HEAD
            <label className="flex flex-col gap-2 text-left text-sm font-heading uppercase tracking-[0.3em] text-mauve/70">
=======
...
<<<<<<< HEAD
                className="rounded-2xl border border-mauve/35 bg-white/90 px-4 py-3 font-body text-sm text-neutral-600 shadow-inner focus:border-mauve focus:outline-none focus:ring-2 focus:ring-mauve/60"
              />
            </label>
            <label className="flex flex-col gap-2 text-left text-sm font-heading uppercase tracking-[0.3em] text-mauve/70">
=======
...
<<<<<<< HEAD
          ...
          <div className="flex flex-col items-center justify-between gap-3 rounded-3xl border border-blush/35 bg-white/85 px-5 py-4 text-xs font-body uppercase tracking-[0.35em] text-neutral-600 sm:flex-row">
            <span className="normal-case tracking-normal">
              Questions? Email <a className="font-semibold text-charcoal underline" href="mailto:RegistryWithTaylor@gmail.com">RegistryWithTaylor@gmail.com</a>
            </span>
            <button
              type="submit"
              className={`inline-flex items-center justify-center rounded-full bg-mauve px-10 py-3 text-xs font-heading uppercase tracking-[0.4em] text-white shadow-soft transition hover:-translate-y-1 hover:scale-105 hover:bg-mauve/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-mauve/60 focus-visible:ring-offset-2 focus-visible:ring-offset-white ${
=======
              className="rounded-2xl border border-babyBlue/35 bg-white/90 px-4 py-3 font-body text-sm text-neutral-600 shadow-inner focus:border-babyBlue focus:outline-none focus:ring-2 focus:ring-babyBlue/60"
            />
          </label>
...
<<<<<<< HEAD
            {status.state === "success" && <span className="text-mauve">{status.message}</span>}
            {status.state === "error" && <span className="text-red-400">{status.message}</span>}
            {status.state === "loading" && <span className="text-mauve/80">{status.message}</span>}
=======
